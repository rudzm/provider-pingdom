...
PROJECT_NAME ?= provider-pingdom
PROJECT_REPO ?= github.com/mrudz/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= DrFaust92/pingdom
export TERRAFORM_PROVIDER_REPO ?= https://github.com/DrFaust92/terraform-provider-pingdom
export TERRAFORM_PROVIDER_VERSION ?= 1.5.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-pingdom
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-pingdomv1.5.0
...
xpkg.build.provider-pingdom: do.build.images
